...
function routerStateEquals(a, b) {
  ...
  return a.location.pathname === b.location.pathname && a.location.search === b.location.search && _deepEqual2['default'](a.location.query, b.location.query) && _deepEqual2['default'](a.location.state, b.location.state);
}
